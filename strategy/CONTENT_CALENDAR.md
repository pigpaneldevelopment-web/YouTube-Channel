...
One long video + 2–3 Shorts (cut from that week's long video) per week. Sequenced from `VIDEO_IDEAS.md` Tier 1, ordered to front-load the strongest hooks and get one real how-to out early for search.
...
| 6 | Claude vs ChatGPT vs Gemini: Which Builds the Best App? | First tool-test pillar video, affiliate-ready |
| 7 | Turn Any Website Into a Phone App (PWA) in 20 Minutes | High search volume how-to |
